...
router.post('/:postId/tags/:tagId', (req, res) => controller.addTagToPost(req, res));
...
router.patch('/:id', (req, res) => controller.updatePost(req, res));
...
router.delete('/:postId/tags/:tagId', (req, res) => controller.removeTagFromPost(req, res));
